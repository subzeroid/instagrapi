...
| location_search_name(LocationName: String)                 | List[Location] | Search Location by Name
| location_search_pk(location: Location)                     | Location       | Return Location info (pk, name, address, lng, lat, external_id, external_id_source,precision)
...
| location_info(location_pk: int)                            | Location       | Return Location info (pk, name, address, lng, lat)
