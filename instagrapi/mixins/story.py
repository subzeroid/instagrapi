...
class StoryMixin:
    ...
    def user_stories_v1(self, user_id: int, amount: int = None) -> List[Story]:
        ...
        headers = {
            ...
            'X-Pigeon-Rawclienttime': self.base_headers['X-Pigeon-Rawclienttime'],
            'X-Ig-Bandwidth-Speed-Kbps': self.base_headers['X-IG-Bandwidth-Speed-KBPS'],
            'X-Ig-Bandwidth-Totalbytes-B': self.base_headers['X-IG-Bandwidth-TotalBytes-B'],
            'X-Ig-Bandwidth-Totaltime-Ms': self.base_headers['X-IG-Bandwidth-TotalTime-MS'],
            ...
            'Ig-U-Ds-User-Id': self.base_headers['IG-U-DS-USER-ID'],
            'Ig-U-Rur': self.base_headers['IG-U-RUR'],
            'Ig-Intended-User-Id': self.base_headers['IG-INTENDED-USER-ID'],
